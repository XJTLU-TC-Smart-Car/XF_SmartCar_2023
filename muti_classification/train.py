...
def train(args):
    ...
    if args.custom_data == True:
        ...
        train_dataset = ImageFolder(train_images_path, transform=data_transform["train"])
        val_dataset = ImageFolder(val_images_path, transform=data_transform["val"])
        test_dataset = ImageFolder(val_images_path, transform=data_transform["val"])
    ...
    model = torchvision.models.efficientnet_b0(num_classes=args.num_classes).to(device)
