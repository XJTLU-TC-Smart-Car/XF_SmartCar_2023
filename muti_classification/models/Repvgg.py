...
#   May be useful for quantization or pruning.
    ...
    def _pad_1x1_to_3x3_tensor(self, kernel1x1):
        if kernel1x1 is None:
            ...
            return torch.nn.functional.pad(kernel1x1, [1,1,1,1]) #就是直接把1*1卷积加上一个单位为1的padding
...
def RepVGG_A1(deploy=False,num_classes=10):
...
def RepVGG_B2g2(deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=100,
...
def RepVGG_D2se(deploy=False):
    return RepVGG(num_blocks=[8, 14, 24, 1], num_classes=100,
